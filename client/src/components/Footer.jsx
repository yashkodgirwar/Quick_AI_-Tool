  ...
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                ...
                <img src={assets.logo} alt="Logo" className="w-32 mb-4" />
                    <p className="mt-6 text-sm">
                        Quick.ai is a powerful AI tool that helps you create amazing content with ease. With our suite of premium AI tools, you can write articles, generate images, and enhance your workflow like never before.
                    </p>
                </div>
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>The latest AI tools and resources, sent to your inbox weekly.</p>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2026 © <a href="/">Quick.ai</a>. All Right Reserved.
            </p>
        </footer>
  )
}
